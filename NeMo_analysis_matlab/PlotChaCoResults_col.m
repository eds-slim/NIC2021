...
for i = 1:size(C,2)  
    ...
    points(i,:) = [mean(p(:,2)),mean(p(:,1)),mean(p(:,3))];
     ...
     if length(unique(lobes))==6
         ...
         %colorsHex = {'#d7191c','#fdae61','#ffffbf','#abd9e9','#d01c8b','#2c7bb6'};
         %colorsHex = {'#DB784D'; '#95CC5E'; '#E84646'; '#F8BB39'; '#7A7267'; '#E1AA93'}; % manual assignment from R color swatch
         %colorsHex = {'#E64B35'; '#4DBBD5'; '#00A087'; '#3C5488'; '#F39B7F'; '#8491B4'}; % manual assignment from R color swatch
         %colorsHex = {'#3B4992'; '#8F264C'; '#E40307'; '#893A1D'; '#197C3D'; '#246058'}; % manual assignment from R color swatch
